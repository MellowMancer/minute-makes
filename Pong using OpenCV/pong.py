...
def multi_player(m, n, ux, uy, flagx, flagy, flag, l, cap, fps):
    ...
    while True:
        ...
        # Displaying the points and pausing the point counter if no face is detected
        if(face == ()):
            cv2.putText(canvas, "Face not detected: Point counters paused", (10, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1, cv2.LINE_AA)
...
while True:
    ...
    if cursor == 0:
        cv2.putText(canvas, "Rally", (860,int(frameHeight/2)+10), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,255), 3, cv2.LINE_AA)
        cv2.putText(canvas, "1v1", (860,int(frameHeight/2)+80), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
        cv2.putText(canvas, "Quit", (860,int(frameHeight/2)+150), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
    elif cursor == 1:
        cv2.putText(canvas, "Rally", (860,int(frameHeight/2)+10), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
        cv2.putText(canvas, "1v1", (860,int(frameHeight/2)+80), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,255), 3, cv2.LINE_AA)
        cv2.putText(canvas, "Quit", (860,int(frameHeight/2)+150), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
    elif cursor == 2:
        cv2.putText(canvas, "Rally", (860,int(frameHeight/2)+10), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
        cv2.putText(canvas, "1v1", (860,int(frameHeight/2)+80), cv2.FONT_HERSHEY_SIMPLEX, 2, (80, 60, 60), 3, cv2.LINE_AA)
        cv2.putText(canvas, "Quit", (860,int(frameHeight/2)+150), cv2.FONT_HERSHEY_SIMPLEX, 2, (255,255,255), 3, cv2.LINE_AA)
    ...
    if key == ord('s'):
        ...
        if cursor == 0:
            ...
            multi_player(m,n,ux,uy,flagx,flagy,flag,l, cap, fps)
        break
    # Rendering the frame
    cv2.imshow("Pong", canvas)
